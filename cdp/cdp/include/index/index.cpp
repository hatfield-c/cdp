...
int indexer::index0(int i_min, int i, int i_max)
...
int indexer::index01(int i_min, int i, int i_max, int j_min, int j, int j_max)
...
int indexer::index012(int i_min, int i, int i_max, int j_min, int j, int j_max,
...
int indexer::index0123(int i1_min, int i1, int i1_max, int i2_min, int i2, int i2_max,
...
int indexer::index0n(int n, int i_min[], int i[], int i_max[])
...
int indexer::index1(int i_min, int i, int i_max)
...
int indexer::index10(int i_min, int i, int i_max, int j_min, int j, int j_max)
...
int indexer::index12(int i_min, int i, int i_max, int j_min, int j, int j_max)
...
int indexer::index123(int i_min, int i, int i_max, int j_min, int j, int j_max,
    int k_min, int k, int k_max)
...
int indexer::index1234(int i1_min, int i1, int i1_max, int i2_min, int i2, int i2_max,
    int i3_min, int i3, int i3_max, int i4_min, int i4, int i4_max)
...
int indexer::index1n(int n, int i_min[], int i[], int i_max[])
...
int indexer::index21(int i_min, int i, int i_max, int j_min, int j, int j_max)
...
int indexer::index210(int i_min, int i, int i_max, int j_min, int j, int j_max,
    int k_min, int k, int k_max)
...
int indexer::index321(int i_min, int i, int i_max, int j_min, int j, int j_max,
    int k_min, int k, int k_max)
...
int indexer::index3210(int i1_min, int i1, int i1_max, int i2_min, int i2, int i2_max,
    int i3_min, int i3, int i3_max, int i4_min, int i4, int i4_max)
...
int indexer::index4321(int i1_min, int i1, int i1_max, int i2_min, int i2, int i2_max,
    int i3_min, int i3, int i3_max, int i4_min, int i4, int i4_max)
...
int indexer::indexn0(int n, int i_min[], int i[], int i_max[])
...
int indexer::indexn1(int n, int i_min[], int i[], int i_max[])
