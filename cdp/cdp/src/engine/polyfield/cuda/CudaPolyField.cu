#include "CudaPolyField.cuh"

__global__ void CudaPolyField::GenerateTrainingData_Kernel(PolyFieldGenerator data_generator) {
    data_generator.GenerateData();
}

void CudaPolyField::GenerateTrainingData() {
    PolyFieldGenerator generator{};
    generator.Init();
    ...
    CudaPolyField::GenerateTrainingData_Kernel<<<blocks_per_grid, threads_per_block>>>(generator);
