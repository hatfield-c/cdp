...
namespace CudaIhm {
	...
	__global__ void RenderHeatmap_Kernel(IhmRenderer ihm_renderer, IhmGenerator ihm_generator, IhmGenerator slice_generator, byte* ihm, byte* ihm_slice, double* score_buffer, byte* img, int direction_index, int height);
	...
	void RenderHeatmap(IhmRenderer ihm_renderer, IhmGenerator ihm_generator, IhmGenerator slice_generator, byte* ihm, byte* ihm_slice, byte* img, int direction_index, int height);
}
