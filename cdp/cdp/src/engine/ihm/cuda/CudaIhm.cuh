...
namespace CudaIhm {
	...
	__global__ void GetChamferDistances_Kernel(IhmCortex ihm_cortex, Vector3* cloud, float* distances);
	...
	float* GetChamferDistances(IhmCortex ihm_cortex, Vector3* cloud);
