...
bool VulkanPipeline::Update() {
    ...
    if (fb_width > 0 && fb_height > 0 && (this->g_SwapChainRebuild || this->g_MainWindowData.Width != fb_width || this->g_MainWindowData.Height != fb_height))
    {
        ...
        ImGui_ImplVulkanH_CreateOrResizeWindow(
            this->g_Instance,
            this->g_PhysicalDevice,
            this->g_Device,
            &this->g_MainWindowData,
            this->g_QueueFamily,
            this->g_Allocator,
            fb_width,
            fb_height,
            this->g_MinImageCount
        );
...
void VulkanPipeline::SetupDevice() {
...
void VulkanPipeline::SetupVulkanWindow(ImGui_ImplVulkanH_Window* wd, VkSurfaceKHR surface, int width, int height)
{
    wd->Surface = surface;
...
void VulkanPipeline::CleanupVulkanWindow()
{
    ImGui_ImplVulkanH_DestroyWindow(g_Instance, g_Device, &g_MainWindowData, g_Allocator);
}

void VulkanPipeline::FrameRender(ImGui_ImplVulkanH_Window* wd, ImDrawData* draw_data)
{
    VkResult err;
...
void VulkanPipeline::FramePresent(ImGui_ImplVulkanH_Window* wd)
{
